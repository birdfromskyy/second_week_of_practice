...
if(isset($_POST['save_practice'])){
    ...
    // Подготовка запроса на добавление данных о практике в базу данных
    $insertPractice = $conn->prepare("INSERT INTO `practics` (vid, type, name, place_practic, address_organization, fio_director_of_company, post_director_of_company,fio_director_of_ugrasu, post_director_of_ugrasu, fio_director_of_organization, post_director_of_organization, from_date, to_date, number_of_prikaz, date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

    // Вставка данных о практике в базу данных
    $insertPractice->execute([$vid, $type, $name, $place_practic, $address_organization, $fio_director_of_company, $post_director_of_company, $fio_director_of_ugrasu, $post_director_of_ugrasu, $fio_director_of_organization, $post_director_of_organization, $from_date, $to_date, $number_of_prikaz, $date]);
    header('location:add_practic.php');
}
